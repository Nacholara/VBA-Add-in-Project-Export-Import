...
Begin {AC0714F6-3D04-11D1-AE7D-00A0C90F26F4} Connect 
   ...
   _ExtentY        =   23495
   _Version        =   393216
   Description     =   "Export classes, forms and modules etc. Also allow re-import of project"
   DisplayName     =   "VBA Export (re-import)"
...
Private Sub AddinInstance_OnConnection( _
    ...
    If ConnectMode = ext_cm_External Then
        ...
        Me.Show
    Else
        Set mcbMenuCommandBar = AddToAddInCommandBar("VBA Export (re-import)")
        'sink the event
...
Function AddToAddInCommandBar( _
    sCaption As String) As Office.CommandBarControl
